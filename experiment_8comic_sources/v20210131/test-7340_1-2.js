...
for (var i = 0; i < 139; i++) {
    ...
    if (o_4x3sz == ch) {
        ...
        var myRet = unescape(be3wy_3 + be3wy_3 + yeyt__y_6o(4) + qs3m4g5_(pzi860b, 0, 1) + m2n766 + i3uevt332 + yeyt__y_6o(3) + yeyt__y_6o(2) + yeyt__y_6o(3) + be3wy_3 + qs3m4g5_(pzi860b, 1, 1) + be3wy_3 + ti + be3wy_3 + o_4x3sz + be3wy_3 + nn(p) + my_6o_ + qs3m4g5_(gtv06u_0p, mm(p), 3) + m2n766 + yeyt__y_6o(1));
        console.log(myRet);
